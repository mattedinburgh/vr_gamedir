...
rem San Mona remaster deployment for the standard nested checkout:
...
echo.
echo San Mona remaster deployment
echo Source: %SRC%
echo Target: %DST%
echo.
...
if exist "%REPO%SAN_MONA_REMASTER_2026-09-13.txt" (
    copy /Y "%REPO%SAN_MONA_REMASTER_2026-09-13.txt" "%GAME%\SAN_MONA_REMASTER_2026-09-13.txt" >nul
)

echo.
echo San Mona remastered maps deployed successfully.
echo.
echo IMPORTANT:
